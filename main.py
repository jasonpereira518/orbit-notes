...
if st.button("Generate Description"):
    ...
    st.markdown("### OrbitNotes for Planet Descriptions")
...
with st.expander("ℹ️  **About this app**", expanded=False):
    ...
    **How it works:**
    ...
    2. Click "Generate Description" to see an AI-crafted narrative based on the planet's data.
    ...
    **Note:** This is a demo application. The generated descriptions may contain imaginative elements and should not be used as factual references.
    """
    )